...
func AgentCatalog() []AgentDefinition {
	...
	return []AgentDefinition{
		...
		{ID: "amp", DisplayName: "Amp", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(configHome, "agents/skills"), DetectPaths: []string{filepath.Join(configHome, "amp")}, ShowInSetup: true},
		{ID: "antigravity", DisplayName: "Antigravity", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(home, ".gemini/antigravity/skills"), DetectPaths: []string{filepath.Join(home, ".gemini/antigravity")}, ShowInSetup: true},
		...
		{ID: "cline", DisplayName: "Cline", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(home, ".agents/skills"), DetectPaths: []string{filepath.Join(home, ".cline")}, ShowInSetup: true},
		...
		{ID: "codex", DisplayName: "Codex", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(codexHome, "skills"), DetectPaths: []string{codexHome, "/etc/codex"}, ShowInSetup: true},
		...
		{ID: "cursor", DisplayName: "Cursor", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(home, ".cursor/skills"), DetectPaths: []string{filepath.Join(home, ".cursor")}, ShowInSetup: true},
		{ID: "deepagents", DisplayName: "Deep Agents", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(home, ".deepagents/agent/skills"), DetectPaths: []string{filepath.Join(home, ".deepagents")}, ShowInSetup: true},
		...
		{ID: "dexto", DisplayName: "Dexto", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(home, ".agents/skills"), DetectPaths: []string{filepath.Join(home, ".dexto")}, ShowInSetup: true},
		...
		{ID: "firebender", DisplayName: "Firebender", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(home, ".firebender/skills"), DetectPaths: []string{filepath.Join(home, ".firebender")}, ShowInSetup: true},
		...
		{ID: "gemini-cli", DisplayName: "Gemini CLI", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(home, ".gemini/skills"), DetectPaths: []string{filepath.Join(home, ".gemini")}, ShowInSetup: true},
		{ID: "github-copilot", DisplayName: "GitHub Copilot", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(home, ".copilot/skills"), DetectPaths: []string{filepath.Join(home, ".copilot")}, ShowInSetup: true},
		...
		{ID: "kimi-cli", DisplayName: "Kimi Code CLI", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(configHome, "agents/skills"), DetectPaths: []string{filepath.Join(home, ".kimi")}, ShowInSetup: true},
		...
		{ID: "opencode", DisplayName: "OpenCode", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(configHome, "opencode/skills"), DetectPaths: []string{filepath.Join(configHome, "opencode")}, ShowInSetup: true},
		...
		{ID: "pi", DisplayName: "Pi", ProjectSkillsDir: ".pi/skills", GlobalSkillsDir: filepath.Join(home, ".pi/agent/skills"), DetectPaths: []string{filepath.Join(home, ".pi/agent")}, ShowInSetup: true},
		...
		{ID: "warp", DisplayName: "Warp", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(home, ".agents/skills"), DetectPaths: []string{filepath.Join(home, ".warp")}, ShowInSetup: true},
		...
		{ID: "universal", DisplayName: "Universal", ProjectSkillsDir: ".agents/skills", GlobalSkillsDir: filepath.Join(configHome, "agents/skills"), ShowInSetup: false},
	}
}
...
func RootsForAgents(agentIDs []string) []string {
	...
	for _, agent := range AgentCatalog() {
		...
		root := filepath.Clean(agent.GlobalSkillsDir)
		if root != "." && !seen[root] {
