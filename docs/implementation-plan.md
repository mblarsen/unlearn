...
- [ ] Replace CLI orchestration tests with audit-interface regression coverage, then keep CLI behavior checks focused on output and persisted opt-ins.
- [ ] Run `go test ./...`, `go build ./...`, and `mise run check` before completion.
